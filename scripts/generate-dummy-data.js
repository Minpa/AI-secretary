...
// Realistic Korean apartment complex requests with apartment unit information
const smsMessages = [
    "203동 엘리베이터가 고장났어요. 3층에서 멈춰있습니다.",
    "101동 1502호에서 주차장 소음이 너무 심해요. 밤늦게까지 시끄럽습니다.",
    "102동 805호 관리비 청구서 확인 부탁드립니다.",
    "5동 803호 화장실 변기가 막혔어요. 수리 요청합니다.",
    "301동 1204호 현관문 도어락이 작동하지 않아요.",
    "101동 1502호 층간소음 때문에 잠을 못 자겠어요.",
    "203동 주차 공간이 부족합니다. 개선 부탁드려요.",
    "102동 쓰레기 분리수거 안내 부탁드립니다.",
    "301동 1204호 인터넷이 자주 끊어져요. 확인 부탁합니다.",
    "5동 803호 보일러가 작동하지 않아요. 추워요.",
    "102동 805호 택배함 비밀번호를 잊어버렸어요.",
    "203동 CCTV 확인 요청드립니다.",
    "301동 1204호 누수가 발생했어요. 긴급 수리 필요합니다.",
    "101동 1502호 전기가 나갔어요. 확인 부탁드립니다.",
    "5동 803호 가스 냄새가 나요. 점검 부탁드립니다.",
    "102동 805호 에어컨이 고장났어요. 더워서 못 살겠어요.",
    "301동 1204호 윗집 소음이 심해요. 조치 부탁드립니다.",
    "203동 주차위반 차량 신고합니다.",
    "관리사무소 전화가 안 받아져요.",
    "101동 1502호 청소가 제대로 안 되고 있어요.",
    "5동 803호 방충망이 찢어졌어요. 교체 부탁드립니다.",
    "102동 805호 화재경보기가 계속 울려요.",
    "301동 1204호 수도꼭지에서 물이 안 나와요.",
    "203동 베란다 배수구가 막혔어요.",
    "101동 공동현관 출입문이 고장났어요.",
    "관리비 할인 문의드립니다.",
    "이사 관련 안내 부탁드립니다.",
    "펜션 예약 문의합니다.",
    "주민회의 일정 알려주세요.",
    ...
    "소화기 점검 언제 하나요?",
    "정전 복구 언제 되나요?",
    "102동 805호 난방비가 너무 많이 나왔어요.",
    "방음 시설 개선 요청합니다.",
    "주차장 조명이 어두워요.",
    "203동 엘리베이터 속도가 너무 느려요.",
    "복도 청소 상태가 안 좋아요.",
    "현관 매트 교체 부탁드립니다.",
    "우편함 열쇠를 잃어버렸어요.",
    "관리비 연체료 문의합니다.",
    "301동 1204호 세대 내 곰팡이 문제 상담 요청합니다.",
    "발코니 방수 공사 언제 하나요?",
    "주차장 CCTV 확인 요청합니다.",
    "관리사무소 운영시간 알려주세요.",
    "입주자 대표회의 참석 방법 문의합니다.",
    "5동 803호 하수구 냄새가 올라와요.",
    "벽지 곰팡이 제거 요청합니다.",
    "101동 1502호 창문 틈새 바람이 들어와요.",
    "전등이 깜빡거려요.",
    "102동 805호 화장실 환풍기가 안 돌아가요."
];

const emailMessages = [
    {
        subject: "203동 엘리베이터 고장 신고",
        body: "안녕하세요. 203동 엘리베이터가 2일째 고장 상태입니다. 고령자분들이 계단 이용에 어려움을 겪고 계십니다. 빠른 수리 부탁드립니다."
    },
    {
        subject: "101동 1502호 주차장 소음 민원",
        body: "101동 1502호 거주자입니다. 매일 밤 11시 이후에도 주차장에서 큰 소리로 대화하시는 분들이 계십니다. 아이들이 잠을 못 자서 힘듭니다. 조치 부탁드립니다."
    },
    {
        subject: "102동 805호 관리비 내역 문의",
        body: "102동 805호입니다. 이번 달 관리비가 평소보다 많이 나왔습니다. 세부 내역을 확인하고 싶습니다. 청구서를 다시 보내주시면 감사하겠습니다."
    },
    {
        subject: "301동 1204호 층간소음 해결 요청",
        body: "301동 1204호 거주자입니다. 윗집에서 새벽 시간대에 발소리와 가구 끄는 소리가 심합니다. 여러 번 직접 말씀드렸지만 개선되지 않고 있습니다. 관리사무소에서 중재해 주세요."
    },
    {
        subject: "5동 803호 보안 시설 점검 요청",
        body: "5동 803호입니다. 현관 도어락과 CCTV 시설에 대한 정기 점검을 요청드립니다. 최근 보안 사고가 늘어나고 있어 걱정됩니다."
    },
    {
        subject: "203동 1105호 수도 시설 문제",
        body: "203동 1105호입니다. 세대 내 수압이 약해서 샤워하기 어렵습니다. 또한 온수가 나오는데 시간이 너무 오래 걸립니다. 점검 부탁드립니다."
    },
    {
...
const webMessages = [
    "101동 1502호 관리비 온라인 납부 방법을 알고 싶습니다.",
    "102동 805호 입주민 커뮤니티 가입 방법 문의합니다.",
    "203동 주차 등록 신청하고 싶어요.",
    "301동 1204호 이사 신고는 어떻게 하나요?",
    "관리사무소 운영 시간이 궁금합니다.",
    "분실물 신고하고 싶어요.",
    "하자보수 신청 방법 알려주세요.",
    "공동 시설 이용 규칙이 궁금해요.",
...
const callTranscripts = [
    "여보세요? 관리사무소죠? 5동 803호인데 저희 집 보일러가 고장났는데 수리기사 연결 부탁드려요.",
    "안녕하세요. 203동 주차장에 불법 주차된 차량이 있어서 신고하려고 전화드렸어요.",
    "102동 805호인데 관리비 관련해서 문의사항이 있어서 전화드렸습니다. 상담 가능한가요?",
    "203동 엘리베이터가 멈춰서 갇혔어요! 빨리 도와주세요!",
    "301동 1204호인데 층간소음 때문에 너무 힘들어요. 어떻게 해결할 수 있을까요?",
